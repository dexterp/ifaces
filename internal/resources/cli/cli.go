...
var usage = `Usage:
  ifaces type [<out>] [(-f <src>)...] [-a] [-p <pkg>] [-i <iface>] [-t <type>] [-s] [--pre <pre>] [--post <post>] [(--tdoc <tdoc>|--no-tdoc)] [--no-fdoc] [-c <cmt>] [--print]
  ifaces method [<out>] [(-f <src>)...] [-a] [-p <pkg>] [-i <iface>] [-t <type>] [-m <func>] [--pre <pre>] [--post <post>] [(--tdoc <tdoc>|--no-tdoc)] [--no-fdoc] [-c <cmt>] [--print]
